...
public class PIDController implements Serializable{
    ...
    public static void main(String[] args){
    	PIDController pidController = new PIDController(0.5, 50, 0.5);
    	pidController.setInputRange(4, 8);
    	pidController.setOutputRange(0, 5);
    	pidController.setSetpoint(6);
    	pidController.enable();
    	
    	double distance = 20; 
    	while(distance != 6){
    		pidController.getInput(distance);
    		double speed = pidController.performPID();
    		System.out.println("Speed: "+ speed);    		
    		distance = distance - Math.ceil(speed);
