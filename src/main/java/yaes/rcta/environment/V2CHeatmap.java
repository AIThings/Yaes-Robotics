...
public class V2CHeatmap implements IValueToColor, constRCTA {

	public enum ColorScheme {
        SimpleColorScheme, SingleHueProgression, BiPolarProgression,
        BlendedHueProgression, PartialSpectralProgression,
        FullSpectralProgression, ValueProgression, UcfTwoColorProgression
	};
	 ...
	 */
	public V2CHeatmap(ColorScheme colorScheme, double valueLow, double valueHigh) {
	...
	/*
	private void initialize(String schemeName) {
		tempScheme.add((Color) Schemes.get(schemeName));
		for (int i = 0; i < SchemeRange; i++) {
	...
	*/
	...
	public Color getColor(double value) {
		...
		case BlendedHueProgression:
		case FullSpectralProgression:
		case PartialSpectralProgression:
		case SingleHueProgression:
		case ValueProgression:
		default:
			throw new Error("colorScheme " + colorScheme
					+ " not implemented yet");
		}
	}
	...
	private Color getColorUcfTwoColorProgression(double value) {
		...
		int g = color1.getGreen()
				+ (int) (blendingRatio * (color2.getGreen() - color1.getGreen()));
